...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/Image_login.svg
  SvgGenImage get imageLogin =>
      const SvgGenImage('assets/icons/Image_login.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/img_log.png
  AssetGenImage get imgLog => const AssetGenImage('assets/images/img_log.png');

  /// File path: assets/images/img_log2.png
  AssetGenImage get imgLog2 =>
      const AssetGenImage('assets/images/img_log2.png');

  /// List of all assets
  List<AssetGenImage> get values => [imgFlags, imgLog, imgLog2];
}
