...
class LullabyHomeView extends StatefulWidget {
  ...
  @override
  State<LullabyHomeView> createState() => _FavoritesViewState();
}

class _FavoritesViewState extends BaseState<LullabyHomeView>
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        body: SafeArea(
          child: BlocBuilder<LullabyHomeViewModel, LullabyHomeState>(
